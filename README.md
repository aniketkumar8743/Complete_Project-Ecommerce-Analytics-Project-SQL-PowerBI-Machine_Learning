...
## 🧠 Objective
To analyze E-commerce sales data to uncover insights on revenue trends, customer behavior, profitability, and operational efficiency using SQL.
...
1. Total Sales Revenue, Total Orders, and Average Profit Margin.
-- use e_commerce
...
Standardized date formats using STR_TO_DATE() and DATE_FORMAT() functions.

Fixed missing or null values in numeric fields using COALESCE() and category fields using 'Unknown'.

Converted discount values from text to numeric percentages.

Verified column datatypes (DECIMAL for prices and profit_margin, DATE for order_date).

📈 Analytical Questions Solved

This project covers 25 key SQL business questions:

Total Revenue, Orders, and Average Profit Margin

Monthly Sales Trend (YoY Growth for 2024 & 2025)
...
Customer Retention, Segmentation by Age

Profitability by Region & Payment Method

Delivery Delays and Return Analysis

YoY Sales Growth using Window Functions

Top 10 Most Valuable Customers

💡 Key Insights

📈 Total revenue increased ~18% YoY (2025 vs 2024).

🛒 Electronics and Fashion categories drive over 60% of total sales.

💰 Highest profit margins observed in Home and Beauty categories.

📦 Average delivery time is 5.6 days, with returns increasing after 8+ days delay.

👥 Top 10 customers contributed 12% of total revenue.

💳 UPI and Credit Card payments have higher profitability than COD.
...
Correlation and Percentage Contribution Analysis
...
This SQL analysis helps stakeholders:

Track sales growth and seasonal performance

Optimize discounts and improve profit margins

Understand customer retention and returns behavior

Improve logistics efficiency (delivery vs. profit)
